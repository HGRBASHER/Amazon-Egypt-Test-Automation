...
public class CartPage extends BasePage{
    ...
    public boolean isOutOfStockMessageDisplayed() {
        ...
        return wait.until(ExpectedConditions.visibilityOfElementLocated(outOfStockMessage)).isDisplayed();
    } catch (Exception e) {
            return false;
        }
    ...
    public void removeProductByTitle(String shortTitle) {
        ...
        for (WebElement item : items) {
            String title = item.findElement(itemTitle).getAttribute("textContent").toLowerCase().trim();
